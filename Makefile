...
lint: ## check style with flake8
	flake8 chibi_donkey tests

coverage: ## check code coverage quickly with the default Python
	coverage run --source chibi_donkey setup.py test
	coverage report -m
	coverage html
	$(BROWSER) coverage_html_report/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/chibi_donkey.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ chibi_donkey
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
pep8:
	...
	@pep8 --statistics chibi_donkey tests
